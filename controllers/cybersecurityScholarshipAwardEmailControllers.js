...
import User from '../models/userSignUpModel.js';
import { sendScholarshipAwardEmail } from '../utils/cybersecurityScholarshipAwardEmail.js';
...
const sendAwardEmailsForCybersecurity = async (request, response) => {
  try {
...
export default sendAwardEmailsForCybersecurity;