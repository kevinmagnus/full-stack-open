...
import User from '../models/userSignUpModel.js';
import { sendScholarshipAwardEmail } from '../utils/fullStackScholarshipAwardEmail.js';
...
const sendAwardEmailsForFullStack = async (request, response) => {
  try {
...
export default sendAwardEmailsForFullStack;